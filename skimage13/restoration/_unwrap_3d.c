...
static const char __pyx_k_Users_junchaowei_scikit_image_s[] = "/Users/junchaowei/scikit-image/skimage/restoration/_unwrap_3d.pyx";
...
/* "skimage/restoration/_unwrap_3d.pyx":9
...
static PyMethodDef __pyx_mdef_7skimage_11restoration_10_unwrap_3d_1unwrap_3d = {"unwrap_3d", (PyCFunction)__pyx_pw_7skimage_11restoration_10_unwrap_3d_1unwrap_3d, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7skimage_11restoration_10_unwrap_3d_1unwrap_3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("unwrap_3d (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mask)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("unwrap_3d", 1, 5, 5, 1); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_unwrapped_image)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("unwrap_3d", 1, 5, 5, 2); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_wrap_around)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("unwrap_3d", 1, 5, 5, 3); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_seed)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("unwrap_3d", 1, 5, 5, 4); __PYX_ERR(0, 9, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "unwrap_3d") < 0)) __PYX_ERR(0, 9, __pyx_L3_error)
      }
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(values[0]); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_mask = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_unsigned_char(values[1]); if (unlikely(!__pyx_v_mask.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_unwrapped_image = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(values[2]); if (unlikely(!__pyx_v_unwrapped_image.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_wrap_around = values[3];
    __pyx_v_seed = values[4];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("unwrap_3d", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_7skimage_11restoration_10_unwrap_3d_unwrap_3d(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_mask, __Pyx_memviewslice __pyx_v_unwrapped_image, PyObject *__pyx_v_wrap_around, PyObject *__pyx_v_seed) {
  ...
  /* "skimage/restoration/_unwrap_3d.pyx":14
 *               wrap_around,
 *               seed):
 ...
 */
  ...
  /* "skimage/restoration/_unwrap_3d.pyx":15
 *               seed):
 *     unwrap3D(&image[0, 0, 0],
 *              &unwrapped_image[0, 0, 0],             # <<<<<<<<<<<<<<
 *              &mask[0, 0, 0],
 ...
 */
  ...
  __pyx_t_4 = -1;
  if (__pyx_t_5 < 0) {
    __pyx_t_5 += __pyx_v_unwrapped_image.shape[0];
    if (unlikely(__pyx_t_5 < 0)) __pyx_t_4 = 0;
  } else if (unlikely(__pyx_t_5 >= __pyx_v_unwrapped_image.shape[0])) __pyx_t_4 = 0;
  if (__pyx_t_6 < 0) {
    __pyx_t_6 += __pyx_v_unwrapped_image.shape[1];
    if (unlikely(__pyx_t_6 < 0)) __pyx_t_4 = 1;
  } else if (unlikely(__pyx_t_6 >= __pyx_v_unwrapped_image.shape[1])) __pyx_t_4 = 1;
  if (__pyx_t_7 < 0) {
    __pyx_t_7 += __pyx_v_unwrapped_image.shape[2];
    if (unlikely(__pyx_t_7 < 0)) __pyx_t_4 = 2;
  } else if (unlikely(__pyx_t_7 >= __pyx_v_unwrapped_image.shape[2])) __pyx_t_4 = 2;
  if (unlikely(__pyx_t_4 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_4);
    __PYX_ERR(0, 15, __pyx_L1_error)
  }

  /* "skimage/restoration/_unwrap_3d.pyx":16
 *     unwrap3D(&image[0, 0, 0],
 *              &unwrapped_image[0, 0, 0],
 *              &mask[0, 0, 0],             # <<<<<<<<<<<<<<
 *              image.shape[2], image.shape[1], image.shape[0], #TODO: check!!!
 ...
 */
  ...
  __pyx_t_4 = -1;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_v_mask.shape[0];
    if (unlikely(__pyx_t_8 < 0)) __pyx_t_4 = 0;
  } else if (unlikely(__pyx_t_8 >= __pyx_v_mask.shape[0])) __pyx_t_4 = 0;
  if (__pyx_t_9 < 0) {
    __pyx_t_9 += __pyx_v_mask.shape[1];
    if (unlikely(__pyx_t_9 < 0)) __pyx_t_4 = 1;
  } else if (unlikely(__pyx_t_9 >= __pyx_v_mask.shape[1])) __pyx_t_4 = 1;
  if (__pyx_t_10 < 0) {
    __pyx_t_10 += __pyx_v_mask.shape[2];
    if (unlikely(__pyx_t_10 < 0)) __pyx_t_4 = 2;
  } else if (unlikely(__pyx_t_10 >= __pyx_v_mask.shape[2])) __pyx_t_4 = 2;
  if (unlikely(__pyx_t_4 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_4);
    __PYX_ERR(0, 16, __pyx_L1_error)
  }

  /* "skimage/restoration/_unwrap_3d.pyx":18
 *              &mask[0, 0, 0],
 *              image.shape[2], image.shape[1], image.shape[0], #TODO: check!!!
 *              wrap_around[2], wrap_around[1], wrap_around[0],             # <<<<<<<<<<<<<<
 *              seed is None, 0 if seed is None else seed)
 */
  __pyx_t_11 = __Pyx_GetItemInt(__pyx_v_wrap_around, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_t_11); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_11 = __Pyx_GetItemInt(__pyx_v_wrap_around, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_12 = __Pyx_PyInt_As_int(__pyx_t_11); if (unlikely((__pyx_t_12 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_11 = __Pyx_GetItemInt(__pyx_v_wrap_around, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_13 = __Pyx_PyInt_As_int(__pyx_t_11); if (unlikely((__pyx_t_13 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
 ...
 *              seed is None, 0 if seed is None else seed)             # <<<<<<<<<<<<<<
 */
  __pyx_t_14 = (__pyx_v_seed == Py_None);
  __pyx_t_16 = (__pyx_v_seed == Py_None);
  if ((__pyx_t_16 != 0)) {
    __pyx_t_15 = 0;
  } else {
    __pyx_t_17 = __Pyx_PyInt_As_unsigned_int(__pyx_v_seed); if (unlikely((__pyx_t_17 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
 ...
 *               double[:, :, ::1] unwrapped_image,
 */
  __pyx_tuple__14 = PyTuple_Pack(5, __pyx_n_s_image, __pyx_n_s_mask, __pyx_n_s_unwrapped_image, __pyx_n_s_wrap_around, __pyx_n_s_seed); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(5, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_junchaowei_scikit_image_s, __pyx_n_s_unwrap_3d, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 9, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_unwrap_3d(void); /*proto*/
PyMODINIT_FUNC init_unwrap_3d(void)
#else
PyMODINIT_FUNC PyInit__unwrap_3d(void); /*proto*/
PyMODINIT_FUNC PyInit__unwrap_3d(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__unwrap_3d(void)", 0);
 ...
 *               double[:, :, ::1] unwrapped_image,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7skimage_11restoration_10_unwrap_3d_1unwrap_3d, NULL, __pyx_n_s_skimage_restoration__unwrap_3d); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_unwrap_3d, __pyx_t_1) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
